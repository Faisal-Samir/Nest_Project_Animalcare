...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      port: 7025,
      username: 'postgres',
      password: 'fB2gla18cgEmySBENwcA',
      database: 'railway',
      //Animal_Care entities: [CustomerEntity,AdaptionEntity,AppointmentEntity,BlogEntity,EmergencyHelpEntity,DoctorEntity,PrescriptionEntity],
